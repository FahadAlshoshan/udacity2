...
public class CarService {
    ...
    public CarService(PriceClient pricing, MapsClient maps, CarRepository repository) {
        /**
    ...
    public Car findById(Long id) {
         ...
         */
        Car carFromDB = repository.findById(id).orElseThrow(CarNotFoundException::new);
        /**
         ...
         */
        carFromDB.setPrice(pricing.getPrice(id));
        /**
         ...
         */
        carFromDB.setLocation(maps.getAddress(new Location(
                carFromDB.getLocation().getLat(), carFromDB.getLocation().getLon())));
